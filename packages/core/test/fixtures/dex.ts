...
const MOVES: readonly Move[] = [
  makeMove({ id: 'earthquake', type: 'ground', category: 'physical', basePower: 100, target: 'all-adjacent' }),
  makeMove({ id: 'dragon-claw', type: 'dragon', category: 'physical', basePower: 80, flags: { contact: true } }),
  makeMove({ id: 'swords-dance', type: 'normal', category: 'status', basePower: 0, accuracy: null, target: 'user' }),
  makeMove({ id: 'protect', type: 'normal', category: 'status', basePower: 0, accuracy: null, priority: 4, target: 'user' }),
  ...
  makeMove({ id: 'close-combat', type: 'fighting', category: 'physical', basePower: 120, flags: { contact: true } }),
  makeMove({
    id: 'surging-strikes',
    type: 'water',
    category: 'physical',
  ...
  makeMove({ id: 'spore', type: 'grass', category: 'status', basePower: 0, flags: { powder: true } }),
  makeMove({ id: 'rage-powder', type: 'bug', category: 'status', basePower: 0, accuracy: null, priority: 2, target: 'user', flags: { powder: true } }),
  makeMove({ id: 'fake-out', type: 'normal', category: 'physical', basePower: 40, priority: 3, flags: { contact: true } }),
  makeMove({ id: 'knock-off', type: 'dark', category: 'physical', basePower: 65, flags: { contact: true } }),
  makeMove({ id: 'body-press', type: 'fighting', category: 'physical', basePower: 80, flags: { contact: true } }),
  ...
  makeMove({ id: 'heat-wave', type: 'fire', category: 'special', basePower: 95, accuracy: 90, target: 'all-adjacent-foes' }),
  makeMove({ id: 'make-it-rain', type: 'steel', category: 'special', basePower: 120, target: 'all-adjacent-foes' }),
  makeMove({ id: 'tera-blast', type: 'normal', category: 'special', basePower: 80 }),
  makeMove({ id: 'wave-crash', type: 'water', category: 'physical', basePower: 120, recoil: 0.33, flags: { contact: true } }),
  makeMove({ id: 'draining-kiss', type: 'fairy', category: 'special', basePower: 50, drain: 0.75, flags: { contact: true } }),
  makeMove({ id: 'sacred-sword', type: 'fighting', category: 'physical', basePower: 90, flags: { contact: true, slicing: true, ignoresDefenseBoosts: true } }),
  makeMove({ id: 'aerial-ace', type: 'flying', category: 'physical', basePower: 60, accuracy: null, flags: { contact: true, slicing: true, alwaysHits: true } }),
]
